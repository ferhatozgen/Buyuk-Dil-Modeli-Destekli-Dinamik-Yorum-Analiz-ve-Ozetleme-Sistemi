...
export default function ProductPage({ product, onFav, onClose, userRating, onRate, allProducts = [], openProduct, ratings = {}, favorites = [] }) {
    ...
    const fetchProductDetails = useCallback(async () => {
        ...
        try {
            ...
            // Yeni yapıya göre kaynak yorumları varsayılan olarak "genel" özetin kaynakları yapalım
            const genelOzet = response.data.summaries?.find(s => s.summaryType === 'genel');
            if (genelOzet && genelOzet.sourceReviews) {
                setActiveSummarySources(genelOzet.sourceReviews);
            }
