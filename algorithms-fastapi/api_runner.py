...
from functions.utils import url_cleaning, url_hashing, url_cozumle, yorumlara_puan_ver, ChatRequest, get_product_rag_context
import requests
...
async def chat_with_vivid_bot(request: ChatRequest):
    try:
        ...
        # 🎯 DÜZELTME: db.close_pool() tehlikeli satırı buradan tamamen kaldırıldı!
